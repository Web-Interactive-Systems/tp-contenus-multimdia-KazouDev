...
type: NoteCard
createdAt: null
viewedAt: 2026-03-17T13:11:26.416Z
---

# Unity XR — lab 1 - Hello XR Mini Aquarium
...
3.  Check the validation and fix the issues
...
4.  Update the Graphics (Edit | Project Settings), choose “Standalone Performant Preset”
    ...
    ![{width=636,height=auto}](../attachments/urp-graphics-cfg.png)
...
6.  Inspect the Camera and change the Renderer in the Rendering, choose Default Renderer (Performant URP Renderer config)
    ...
    ![{width=496,height=auto}](../attachments/urp-graphics-camera-cfg.png)
