...
![{width=495,height=auto}](../attachments/build-settings.png)— Figure: Build Settings
...
![{width=500,height=auto}](../attachments/project-settings.png)— Figure: Project Settings
