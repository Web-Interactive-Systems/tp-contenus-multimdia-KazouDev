...
type: NoteCard
createdAt: null
viewedAt: 2026-03-17T13:03:32.975Z
---

# Intro — XR Unity - Course Introduction

![{width=413,height=auto}](../attachments/Immersive-digital-learning.png)— source: <https://laval-virtual.com/>
...
- Scripting: In addition to structured editor, and visual programming, Unity offers a programming approach called scripting, using C# (.NET C-Sharp) to create more advanced features.
