...
type: NoteCard
createdAt: null
viewedAt: 2025-09-01T08:17:42.463Z
---

# lab1 - Unity MonoBehaviour

![{width=474,height=auto}](../attachments/input-system.jpg)— source: [Unity Blog](https://blog.unity.com/engine-platform/introducing-the-new-input-system)
...
**MonoBehaviour** is _the script component_ type. A script component will be then attached to a gameObject, and participate in the gameObject’s update loop (code that runs every fame).
